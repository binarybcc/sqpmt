...
class SQPMT_Settings {
    ...
    public function register_settings() {
        ...
        // Application ID
        register_setting('sqpmt_settings', 'sqpmt_application_id', array(
            'type' => 'string',
        ...
        // Access Token
        register_setting('sqpmt_settings', 'sqpmt_access_token', array(
            'type' => 'string',
        ...
        // Location ID
        register_setting('sqpmt_settings', 'sqpmt_location_id', array(
            'type' => 'string',
            'sanitize_callback' => 'sanitize_text_field',
        ));
        ...
        // Sandbox Mode
        register_setting('sqpmt_settings', 'sqpmt_sandbox_mode', array(
            'type' => 'string',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => 'yes'
        ));
        ...
        register_setting('sqpmt_settings', 'sqpmt_service_fee', array(
            'type' => 'number',
        ...
        // Minimum Amount
        register_setting('sqpmt_settings', 'sqpmt_minimum_amount', array(
            'type' => 'number',
        ...
        // Success Message
        register_setting('sqpmt_settings', 'sqpmt_success_message', array(
            'type' => 'string',
        ...
        // Failure Message
        register_setting('sqpmt_settings', 'sqpmt_failure_message', array(
            'type' => 'string',
            'sanitize_callback' => 'wp_kses_post',
        ));
        ...
        register_setting('sqpmt_settings', 'sqpmt_customer_email_enabled', array(
            'type' => 'string',
            'sanitize_callback' => 'sanitize_text_field',
            'default' => 'yes'
        ));
